...
describe('grid page', function () {
    ...
    it('should show elements on grid page', function () {
        ...
        expect(gridPage.searchField.isPresent()).toBeTruthy();
        expect(gridPage.searchField.isEnabled()).toBeTruthy();
        gridPage.searchField.sendKeys('ala bala');

        expect(gridPage.searchField.getAttribute('value')).toEqual('ala bala');
        var header=["Name","Company","Email","Enabled","Added"];
        gridPage.checkHeader(header)
