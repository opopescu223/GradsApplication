...
describe('home page', function () {
    ...
    it('should show elements on page', function () {
        ...
        expect(homePage.nameInput.getAttribute('value')).toEqual("afasfa");
        expect(homePage.nameInputDiv.getText()).toEqual('This is the name you have entered: afasfa');
        expect(homePage.nameInputDiv.getText()).toContain('entered: afasfa');
        expect(homePage.nameInputDivBinding.getText()).toContain('entered: afasfa');
